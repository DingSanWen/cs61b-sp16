...
public class Editor extends Application {
    ...
    private ArrayList<String> charactersTyped = new ArrayList<String>();
        ...
        public void handle(KeyEvent keyEvent) {
            if (keyEvent.getEventType() == KeyEvent.KEY_TYPED) {
                ...
                if (characterTyped.length() > 0 && characterTyped.charAt(0) != 8) {
                    ...
                    charactersTyped.add(characterTyped);
                    String stringTyped = String.join("", charactersTyped);
                    displayText.setText(stringTyped);
                    keyEvent.consume();
                }
                ...
                if (code == KeyCode.UP) {
                    ...
                    charactersTyped.remove(charactersTyped.size() - 1);
                    String stringTyped = String.join("", charactersTyped);
                    displayText.setText(stringTyped);
                    keyEvent.consume();
                }
